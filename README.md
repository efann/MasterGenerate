...
From all the forums that I've researched over the last two years or so, I've realized there tend to be two types of master documents: (1) those that are corrupt, (2) those that are about to corrupt.

Instead, I use LibreOffice to generate the master document.

The below instructions exist for manually generating the master Word document. 
